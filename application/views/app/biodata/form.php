...
<form action="<?php echo (empty($this->input->get('form')) and $update == false) ? base_url('app/biodata/create') : (($update == false) ? base_url('app/biodata/store') : base_url('app/biodata/update')) ?>" class="row" method="<?php echo (empty($this->input->get('form')) AND $update == false) ? 'GET' : 'POST' ?>" enctype="multipart/form-data">
                ...
                <div class="c-card c-card--responsive h-100vh u-p-zero">
                    <div class="c-card__header c-card__header--transparent o-line">
                        <?php if ($this->input->get('form') or $update): ?>
                            ...
                            <?php if (!$update): ?>
                                <a href='<?php echo base_url('app/biodata/create') ?>' class="c-btn c-btn--danger c-btn--custom c-btn--small u-ml-auto" type="submit" title="publish">
