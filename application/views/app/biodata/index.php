        ...
        <div class="col-md-12">
            ...
            <div class="c-card c-card--responsive h-100vh u-p-zero">
                <div class="c-card__header c-card__header--transparent o-line">
                    <a class="c-btn--custom c-btn--small c-btn c-btn--info" href="<?php echo base_url('app/biodata/create') ?>">
                        <i class="fa fa-plus"></i>
                    </a>    

                    <button disabled="" type="button" class="c-btn--custom c-btn--small c-btn c-btn--info u-ml-auto action-update" data-href="<?php echo base_url('app/biodata/edit') ?>">
                        <i class="fa fa-edit"></i>
                    </button>  
                    <button disabled="" class="c-btn--custom c-btn--small c-btn c-btn--danger u-ml-small action-delete" type="button" data-href='<?php echo base_url('app/biodata/delete') ?>'>
